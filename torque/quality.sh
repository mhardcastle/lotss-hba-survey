...
/soft/singularity-3.8.4/bin/singularity run -B/soft/,/beegfs,/data /data/lofar/mjh/ddf_py3_d11.simg quality_pipeline.py /usr/local/src/ddf-pipeline/examples/quality-example.cfg
